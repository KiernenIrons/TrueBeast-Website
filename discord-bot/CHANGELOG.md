...
- Added `autoDelete` helper that calls `deleteReply()` after 10 seconds so confirmations don't accumulate
- All paths (success, error, early-return guards) schedule auto-delete
