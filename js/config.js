...
const SITE_CONFIG = {
    ...
    giveaways: [
        ...
        { item: 'Ultimate Game Pass - 3 Months', winner: 'Mitsukunii', description: 'A 3 month Xbox Ultimate Game Pass', image: 'assets/images/winners/Xbox12month.jpg', date: '2023-12-24', status: 'ended' },
        { item: 'Ultimate Game Pass - 3 Months', winner: 'TinyKay', description: 'A 3 month Xbox Ultimate Game Pass', image: 'assets/images/winners/Xbox12month.jpg', date: '2023-12-24', status: 'ended' },
        { item: 'Ultimate Game Pass - 3 Months', winner: 'SoundLogic', description: 'A 3 month Xbox Ultimate Game Pass', image: 'assets/images/winners/Xbox12month.jpg', date: '2023-12-24', status: 'ended' },
